										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="Enter Longitude" required placeholder="Enter Longitude">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Latitude</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="Enter Latitude" required placeholder="Enter Latitude">
													</div>
												</div>
											</div>
											<div class="col-xl-6">
