...
if(isset($_POST['id'])) {
  ...
  $query = "UPDATE property SET isApprove	='APPROVE' WHERE pid='$propertyId'";
...
if(isset($_POST['action']) && $_POST['action'] == 'reject') {
  ...
  $query = "UPDATE property SET isApprove='REJECT' WHERE pid='$propertyId'";
                                        ...
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="../admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <button type="button" id="approveButton_<?php echo $row['pid'];?>" class="btn btn-success approveBtn" data-id="<?php echo $row['pid'];?>">Approve</button>
                                                      ...
                                                      <button type="button" id="rejectButton_<?php echo $row['pid'];?>" class="btn btn-danger rejectButton" data-id="<?php echo $row['pid'];?>" data-action="reject">Reject</button>
